...
import com.example.asus.study.util.DateUtil;

public class LTS_Activity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    private TextView tv_bbs;
    private TextView tv_controal;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_controal = findViewById(R.id.tv_control);
        tv_controal.setOnClickListener(this);
        tv_controal.setOnLongClickListener(this);
